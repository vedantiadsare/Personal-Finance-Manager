            ...
            for category in budget_categories:
                if category['target_amount'] > 0:
                    ...
                    if actual_percentage >= 90:
                        ...
                        flash(f'Budget Alert! {random.choice(messages_90)} You\'ve exceeded your {category["period"]} budget for {category["name"]} ({category["date_range"]}) by ₹{exceeded:.2f}!', 'warning')
                        ...
                        flash(f'Budget Alert! {random.choice(messages_80)} You\'ve used {actual_percentage:.1f}% of your {category["period"]} budget for {category["name"]} ({category["date_range"]})!', 'warning')
                        ...
                        flash(f'Budget Alert! {random.choice(messages_50)} You\'ve spent ₹{category["spent"]:.2f} out of ₹{category["target_amount"]:.2f} for {category["name"]} ({category["date_range"]})', 'info')
        ...
        for category in categories:
            ...
            if category['target_amount'] > 0:
                ...
                if actual_percentage >= 90:
                    ...
                    exceeded = category['spent'] - category['target_amount']
                    flash(f'Budget Alert! {random.choice(messages_80)} You\'ve exceeded your {category["period"]} budget for {category["name"]} ({category["date_range"]}) by ₹{exceeded:.2f}!', 'warning')
                elif actual_percentage >= 50:
                    messages_50 = [
                        'Arey waah, aadha budget uda diya! Date pe jaise kharcha—controlled but thoda naughty.',
                        '50% ho gaya! Budget dekh raha hai tumhe—thoda sambhal ja!',
